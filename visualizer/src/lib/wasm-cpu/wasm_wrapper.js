...
const MyCpuControllerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mycpucontroller_free(ptr >>> 0, 1));
...
export class MyCpuController {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MyCpuControllerFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mycpucontroller_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.mycpucontroller_new();
        this.__wbg_ptr = ret >>> 0;
        MyCpuControllerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    free() {
        ...
        const ptr = this.__destroy_into_raw();
        _assertNum(ptr);
        wasm.mycpucontroller_free(ptr);
    }
    /**
     * @param {string} assembly_string
     * @returns {boolean}
     */
    loadProgram(assembly_string) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ptr0 = passStringToWasm0(assembly_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.mycpucontroller_loadProgram(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @returns {any}
    ...
    step() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.mycpucontroller_step(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {any}
    ...
    getState() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.mycpucontroller_getState(this.__wbg_ptr);
        return ret;
    }
    reset() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        wasm.mycpucontroller_reset(this.__wbg_ptr);
    }
}
if (Symbol.dispose) MyCpuController.prototype[Symbol.dispose] = MyCpuController.prototype.free;
