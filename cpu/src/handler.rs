...
impl MyCPU {
    ...
    pub fn output_16(&mut self, _: &[u32]) -> Result<(), CPUError> {
    ...
    pub fn output_char(&mut self, operands: &[u32]) -> Result<(), CPUError> {
        let register = operands[0];
        let value = self.register.get(register)? as i8;
    ...
    pub fn adc(&mut self, operands: &[u32], immediate: bool) -> Result<(), CPUError> {
        let dest = operands[0];
        let num1 = self.register.get(operands[1])?;
        let num2 = if immediate {
            operands[2] as u8
    ...
    pub fn sbc(&mut self, operands: &[u32], immediate: bool) -> Result<(), CPUError> {
        let dest = operands[0];
        let num1 = self.register.get(operands[1])?;
        let num2 = if immediate {
            operands[2] as u8
    ...
    pub fn mult(&mut self, operands: &[u32], immediate: bool) -> Result<(), CPUError> {
        ...
        println!("lowbyte: {lowbyte}, highbyte: {highbyte}");
    ...
    pub fn mult_16(&mut self, operands: &[u32], immediate: bool) -> Result<(), CPUError> {
    ...
    pub fn jge(&mut self, operands: &[u32]) {
        let address = operands[0];
